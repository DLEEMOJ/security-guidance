...
-   When transferring security clearance from another Government department, Protective Security Centre (PSC) Operations via [Security team](mailto:security@justice.gov.uk) **shall** confirm if the security clearance is valid and current. If not, a new security clearance application **shall** be started.
